...
export namespace Config {
  ...
  export const inversePageUrlOverrides =
    invertPageUrlOverrides(pageUrlOverrides)
  ...
  export const email: string = getSiteConfig('email', 'ourcompany@email.com')
  export const phoneNumber: string = getSiteConfig('phoneNumber', '55555555555')
  ...
  export const yelp: string | null = getSiteConfig('yelp', null)
