...
This uses Notion as a CMS, fetching content from Notion and then uses [Next.js](https://nextjs.org/) and [notion-forge](https://github.com/nolantait/notion-forge) to render everything.
...
- Robust support for Notion content via [notion-forge](https://github.com/NotionX/notion-forge)
...
Credit to [Travis Fischer](https://transitivebullsh.it) for his work on [react-notion-x](https://github.com/NotionX/react-notion-x)

Support his open source work by <a href="https://twitter.com/transitive_bs">following him on twitter <img src="https://storage.googleapis.com/saasify-assets/twitter-logo.svg" alt="twitter" height="24px" align="center"></a>
